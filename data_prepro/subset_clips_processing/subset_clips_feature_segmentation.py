...
def uniform_subsample(tensor, num_samples):
    ...
    if total_frames == 0 or total_frames < num_samples:
        ...
        f = open("/home/adrienne/AutoMAD/datasets/test/test-clips-under-8frames.txt", "a")
...
output_file = '/home/adrienne/AutoMAD/datasets/32_clips_tsv/32_clips_test_features.tsv'
...
with open(output_file, 'w', newline='') as file:
    ...
    previous_movie_id = 0
    annotation_count = 0  # Initialize annotation counter

    for annotation in annotations_list:
        if annotation_count >= 32:
            break  ## STOP AFTER PROCESSING X ANNOTATIONS ##
        ...
        if subsampled_feature_tensor is None:
            continue
